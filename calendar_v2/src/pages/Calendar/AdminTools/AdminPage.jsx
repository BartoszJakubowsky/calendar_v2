...
export default function AdminPage({calendar, setCalendar}) {
    ...
    return (
        <div className="fixed inset-0 z-20 overflow-auto">
                        <FloatingPanel className='bg-accentMedium dark:bg-dark-accentMedium p-2 z-20 w-[400px] h-full right-0 absolute top-0 min-w-[150px]'>
                            <h3>Ustawienia globalne</h3>
                            <h3 
                             className="text-lg rounded-sm bg-accentLight dark:bg-dark-accentLight border-b-2  border-accentMedium dark:border-dark-accentMedium"
