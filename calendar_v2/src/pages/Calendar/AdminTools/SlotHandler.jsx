...
export default function SlotHandler({slot, slotIndex, columnIndex, dayIndex, weekIndex, monthIndex, children, calendar, setCalendar, translate}) {
    

    const [erase, setErase] = useState(slot.erase)
    const [messages, setMessages] = useState(slot.messages)
    ...
    const handleCalendarUpdate = () => {
        ...
        return (
            <>
            <LabelInput 
            labelText={translate('removeSlot')} 
            value={erase} 
            setValue={setErase} 
            inputType={'checkbox'} 
