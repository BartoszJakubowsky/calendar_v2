 ...
 * const containerClassName = inside div containeer
 * //default component
 * return (
 *   <Carousel 
...
export default function Carousel({ startPosition = 0, pages, swipeToIndex, swipeDuration, swipeEase, containerClassName ,...rest }) 
{
